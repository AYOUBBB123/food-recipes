...
export default function Navbar() {
    ...
    const { searchParam, setsearchParam, handleSubmit, handlesearchParam } = useContext(GlobalContext)
    console.log(searchParam)

    return <nav className="flex justify-between items-center py-8 container mx-auto flex-col lg:flex-row gap-5 lg:gap-0">
        <h2 onClick={handlesearchParam} className=" text-2xl font-semibold"><NavLink to={"/"} >FoodRecipe
        </NavLink></h2>
        <form onSubmit={handleSubmit}>
            <input
                ...
                className="bg-white/75 p-3 px-8 rounded-full outline-none lg:w-96 shadow-lg shadow-red-200"
            />
